...
public class ProjectTableItemFragmentInteractor implements IProjectTableItemInteractor, IBaseFragmentInteractor {
    ...
    public ProjectTableItemFragmentInteractor() {
